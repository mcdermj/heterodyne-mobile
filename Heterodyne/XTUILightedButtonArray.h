...
@interface XTUILightedButtonArray : UIView
@property IBOutlet id delegate;
@property NSString *selected;
@end

@protocol XTLightedButtonArrayDelegate <NSObject>
@optional
-(NSArray *)contentForButtonArray:(XTUILightedButtonArray *)array;
